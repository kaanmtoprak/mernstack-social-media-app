    ...
    return (
      <aside className="sidebar">
          <nav className="sidebar__nav">
             ...
             <Link className={classNames('sidebar__nav__link',{"active-link" : window.location.pathname === "/profile"} )} to ='/profile'><span><i className='icon-group'></i>Profile</span><i className='icon-chevron-right'></i></Link>
